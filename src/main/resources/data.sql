...
INSERT INTO product (id, name, price, picture_url ) VALUES (1, 'TV Set', 300.00, 'http://placehold.it/200x100');
INSERT INTO product (id, name, price, picture_url ) VALUES (2, 'Game Console', 200.00, 'http://placehold.it/200x100');
INSERT INTO product (id, name, price, picture_url ) VALUES (3, 'Sofa', 100.00, 'http://placehold.it/200x100');
INSERT INTO product (id, name, price, picture_url ) VALUES (4, 'Icecream', 5.00, 'http://placehold.it/200x100');
INSERT INTO product (id, name, price, picture_url ) VALUES (5, 'Beer', 3.00, 'http://placehold.it/200x100');
INSERT INTO product (id, name, price, picture_url ) VALUES (6, 'Phone', 500.00, 'http://placehold.it/200x100');
INSERT INTO product (id, name, price, picture_url ) VALUES (7, 'Watch', 30.00, 'http://placehold.it/200x100');
